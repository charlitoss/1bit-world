...
- **Light / dark theme** — toggle in the header (follows your system by default).
- **Logo** — the Earth mark is generated by this tool's own dither
  (`scripts/make-logo.mjs` → `components/ui/EarthLogo.tsx`).

The app fills the viewport: the image area never scrolls, and the controls
